# WEEK 20 RESOURCES — PHASE 2 ORIENTATION: INFRASTRUCTURE AS CODE

**Week 20 | Phase: Phase 2 Orientation (Infrastructure as Code & Orchestration)**

## 🎯 Resources Objective

Consolidate Week 20's transition from AWS Cloud theoretical study into hands-on Phase 2 Engineering through a detailed resources document.

### 1️⃣ Phase 2 Transition

**Reference Material:** Shifted focus from AWS SAA-C03 multiple-choice theory to writing actual Infrastructure as Code.

[Official Documentation: Phase 2 Transition](https://docs.aws.amazon.com/)
[CNCF Community Slack](https://slack.cncf.io/)

**Resource Value:** ClickOps is dead. All future infrastructure will be written declaratively, version-controlled, and peer-reviewed.

---

### 2️⃣ Terraform Fundamentals

**Reference Material:** Installed the Terraform CLI, initialized the AWS Provider, and studied HCL (HashiCorp Configuration Language).

[Official Documentation: Terraform Fundamentals](https://docs.aws.amazon.com/)
[CNCF Community Slack](https://slack.cncf.io/)

**Resource Value:** Terraform acts as the bridge to AWS. The Write -> Plan -> Apply lifecycle prevents catastrophic deployment errors.

---

### 3️⃣ Docker & Containerization

**Reference Material:** Installed Docker Desktop, analyzed Containers vs VMs, and deployed isolated Nginx and Python environments.

[Official Documentation: Docker & Containerization](https://docs.aws.amazon.com/)
[CNCF Community Slack](https://slack.cncf.io/)

**Resource Value:** Containers share the host kernel, enabling millisecond boot times and massive resource efficiency compared to heavy VMs.

---

### 4️⃣ Dockerfiles & Volumes

**Reference Material:** Engineered custom Dockerfiles (FROM, WORKDIR, COPY, CMD) and established data persistence via bind mounts.

[Official Documentation: Dockerfiles & Volumes](https://docs.aws.amazon.com/)
[CNCF Community Slack](https://slack.cncf.io/)

**Resource Value:** Containers are ephemeral; any critical data must be mapped to a host volume to survive a container restart.

---

### 5️⃣ Kubernetes Orchestration

**Reference Material:** Installed kubectl and Minikube, deployed Pods, and exposed services using NodePorts.

[Official Documentation: Kubernetes Orchestration](https://docs.aws.amazon.com/)
[CNCF Community Slack](https://slack.cncf.io/)

**Resource Value:** Docker runs the application, but Kubernetes orchestrates the fleet, ensuring self-healing, scaling, and rolling updates.

---

### 6️⃣ Workstation & IAM Security

**Reference Material:** Secured local AWS credentials by creating a dedicated IAM `terraform` profile with programmatic access.

[Official Documentation: Workstation & IAM Security](https://docs.aws.amazon.com/)
[CNCF Community Slack](https://slack.cncf.io/)

**Resource Value:** Never use the root AWS account for IaC. Always isolate programmatic execution through dedicated, auditable IAM service users.
